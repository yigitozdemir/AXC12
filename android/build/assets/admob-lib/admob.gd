...
@export_enum("ADAPTIVE_BANNER", "SMART_BANNER", "BANNER", "LARGE_BANNER", "MEDIUM_RECTANGLE", "FULL_BANNER", "LEADERBOARD") var banner_size = 0 # =  "ADAPTIVE_BANNER"
...
@export_enum("G", "PG", "T", "MA") var max_ad_content_rate = 0: set = max_ad_content_rate_set
